...
++++
<!-- BEGIN cards:featured -->
<div class="hub-cards">
  <a class="hub-card" href="/jvmlens/current/">
  ...
  <a class="hub-card" href="/jhelm/current/">
  ...
  <a class="hub-card" href="/alexmskills/">
    <span class="hub-card-name">alexmskills</span>
    <span class="hub-card-desc">A curated Claude Code marketplace of <strong>self-learning</strong> skills and agents — a <code>CLAUDE.md</code> that prunes its own decisions, a delivery crew, a brainstorm panel, evolving roles, and a prompt coach that nudges you toward better prompts.</span>
    <span class="hub-card-tags">claude code · self-learning</span>
  </a>
  <a class="hub-card" href="/unitrack/">
...
++++
<!-- BEGIN cards:libraries -->
<div class="hub-cards">
  <a class="hub-card" href="/gotmpl4j/current/">
    <span class="hub-card-name">gotmpl4j</span>
    <span class="hub-card-desc">Pure-Java Go <code>text/template</code> + Sprig — no Go toolchain. Byte-for-byte parity across <strong>1,305 of Go's own test cases</strong>. The engine under jhelm.</span>
    <span class="hub-card-tags">go template · jvm</span>
  </a>
  <a class="hub-card" href="/gotmpl4j-spring-boot/current/">
    <span class="hub-card-name">gotmpl4j-spring-boot</span>
    <span class="hub-card-desc">Spring Boot integration for gotmpl4j — starter, MVC/WebFlux <code>ViewResolver</code>, and Spring-context template functions. <strong>One branch per Spring Boot line</strong>, versioned to match.</span>
    <span class="hub-card-tags">spring boot · go template</span>
  </a>
  <a class="hub-card" href="/notify4j/current/">
  ...
  <a class="hub-card" href="/spring-boot-config-json-schema-starter/current/">
  ...
  <a class="hub-card" href="/extensions/current/">
  ...
  <a class="hub-card" href="/jsupervisor/current/">
  ...
  <a class="hub-card" href="/yj-schema-validator/current/">
  ...
  <a class="hub-card" href="/spring-boot-playground/current/">
